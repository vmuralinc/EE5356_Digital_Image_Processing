function overall_mssim = msssim(img1, img2, level, weight, K, win, method)
...
im2 = double(img2);
for l = 1:level
   [mssim_array(l) ssim_map_array{l} mcs_array(l) cs_map_array{l}] = my_ssim_index(im1, im2, K, win);
%   [M N] = size(im1);
